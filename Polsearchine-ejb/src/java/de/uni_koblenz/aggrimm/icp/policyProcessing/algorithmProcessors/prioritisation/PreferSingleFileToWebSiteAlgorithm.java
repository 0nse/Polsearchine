 ...
 * it's a single file like a {@code WebPage} it gets a higher priority than if
 * it's a {@code WebSite}.
 *
 * @author mruster
 */
public class PreferSingleFileToWebSiteAlgorithm extends PrioritisationAlgorithm {
	...
	protected List<List<PrioritisedRule>> executeAlgorithm(List<PrioritisedRule> group) {
		return PreferSingleFileOrWebSite.apply(group, false);
	}
}
