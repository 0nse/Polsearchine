 ...
 * domain name, beginning with the longest domain name. The length of a domain
 ...
 * @author mruster
 */
public class PreferLongestDomainNameAlgorithm extends PrioritisationAlgorithm {
