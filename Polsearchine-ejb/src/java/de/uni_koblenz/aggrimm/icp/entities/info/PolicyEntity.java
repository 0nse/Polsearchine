...
public class PolicyEntity implements Serializable {
	...
	private static final long serialVersionUID = -4588074306753915949L;
	@Id
	...
	public PolicyEntity() {
		legalAuthorizations = new LinkedList<>();
		organizationalMotivations = new LinkedList<>();
	}
	...
	public boolean equals(Object object) {
		...
		PolicyEntity other = (PolicyEntity) object;
	...
	public String toString() {
		return "de.uni_koblenz.aggrimm.icp.entities.info.PolicyMethod[ id=" + id + " ]";
	}
}
