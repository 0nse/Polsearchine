 ...
 * domain name, beginning with the shortest domain name. The length of a domain
 * name corresponds to the number of labels it contains.
 ...
 * @author mruster
 */
public class PreferShortestDomainNameAlgorithm extends PrioritisationAlgorithm {
