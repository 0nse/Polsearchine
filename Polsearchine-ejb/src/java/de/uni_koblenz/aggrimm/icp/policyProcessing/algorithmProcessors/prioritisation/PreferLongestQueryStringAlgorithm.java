 ...
 * query string, beginning with the longest query string. The length of a query
 ...
 * @author mruster
 */
public class PreferLongestQueryStringAlgorithm extends PrioritisationAlgorithm {
	...
	protected List<List<PrioritisedRule>> executeAlgorithm(List<PrioritisedRule> group) throws URISyntaxException {
		return PreferXDomainName.apply(group, false);
	}
}
