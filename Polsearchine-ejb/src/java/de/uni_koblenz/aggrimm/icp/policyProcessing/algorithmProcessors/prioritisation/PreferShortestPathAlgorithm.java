 ...
 * local path, beginning with the shortest path. The length of a path
 * corresponds to the number of directory sections it contains.
 ...
 * @author mruster
 */
public class PreferShortestPathAlgorithm extends PrioritisationAlgorithm {
	...
	protected List<List<PrioritisedRule>> executeAlgorithm(List<PrioritisedRule> group) throws URISyntaxException {
		return PreferXPath.apply(group, true);
	}
}
