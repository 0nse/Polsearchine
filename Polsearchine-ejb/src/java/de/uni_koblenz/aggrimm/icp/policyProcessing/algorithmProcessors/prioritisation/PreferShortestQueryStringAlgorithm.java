...
import de.uni_koblenz.aggrimm.icp.policyProcessing.algorithmProcessors.prioritisation.logic.PreferXDomainName;
 ...
 * query string, beginning with the shortest query string. The length of a query
 * string corresponds to the number of query parameters it contains.
 ...
 * @author mruster
 */
public class PreferShortestQueryStringAlgorithm extends PrioritisationAlgorithm {
	...
	protected List<List<PrioritisedRule>> executeAlgorithm(List<PrioritisedRule> group) throws URISyntaxException {
		return PreferXDomainName.apply(group, true);
	}
}
